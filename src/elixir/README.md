# Elixir adapter boundary

This directory is reserved for the Elixir implementation of
...
TypeScript/JavaScript, and Go. The Elixir implementation follows in a separate
