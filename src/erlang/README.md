# Erlang adapter boundary

This directory is reserved for the Erlang implementation of
...
TypeScript/JavaScript, and Go. The Erlang implementation follows in a separate
